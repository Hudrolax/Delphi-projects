...
2.11 - 27.11.2005 - Доработан демо-пример "Terminal".
2.12 - 01.12.2005 - Методы Open и Close теперь не функции, а процедуры. Внесены
       соответствующие изменения в файл справки и демонстрационные примеры.
2.13 - 21.07.2006 - Устранена ошибка в дополнительной процедуре EnumComPorts.
