...
interface
uses SysUtils, Types, Windows, TLHELP32, Classes, StdCtrls, SHFolder, ShlObj;
...
var ND:integer;
vall,autoref,ADMMod,OrdToExport,dlg1:boolean;
RowS:integer;
IDSel,Gtmp,Gincass:string;
tbl:array of Ttbl;
  PrikaziArowS,PrikaziAcolS,mailtamrowselect:integer;
